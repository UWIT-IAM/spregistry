...
public class FilterPolicyManagerTest {
  ...
  public void testGetFilterPolicy() throws Exception {
    ...
    AttributeFilterPolicy attributeFilterPolicy =
        filterPolicyManager.getFilterPolicy(
            filterPolicyGroup, "https://diafine3.cac.washington.edu/shibboleth");
    Assert.assertNotNull(attributeFilterPolicy);
    Assert.assertEquals(8, attributeFilterPolicy.getAttributeRules().size());
    attributeFilterPolicy =
        filterPolicyManager.getFilterPolicy(
            filterPolicyGroup, "https://jpf.cac.washington.edu/shibboleth");
