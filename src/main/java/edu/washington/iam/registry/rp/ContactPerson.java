...
public class ContactPerson implements Serializable {
  ...
  public void writeXml(BufferedWriter xout) throws IOException {
    ...
    if (givenName != null)
      xout.write("   <GivenName>" + XMLHelper.safeXml(givenName) + "</GivenName>\n");
    if (surName != null) xout.write("   <SurName>" + XMLHelper.safeXml(surName) + "</SurName>\n");
    if (email != null)
      xout.write("   <EmailAddress>" + XMLHelper.safeXml(email) + "</EmailAddress>\n");
    if (phone != null)
      xout.write("   <TelephoneNumber>" + XMLHelper.safeXml(phone) + "</TelephoneNumber>\n");
